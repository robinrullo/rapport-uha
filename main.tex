...
\logoentreprise{logos/logo-entreprise.jpg}

\titre{D'un logiciel lourd à un client web léger} % Titre du fichier

\typerapport{Rapport de stage} % Type de rapport
\filiere{Licence professionnelle \\ développeur informatique} % Nom de la filière
\promotion{Promotion 2020-2021} % Promotion
\niveau{UHA 4.0.0}

\eleve{Prenom Nom} % Nom de l'élève
\trigrammemention{Prenom NOM} % Pour le bas de la page
